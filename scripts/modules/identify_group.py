...
def identify_group(pwd,pdbfilename,index,conf_df):
    ...
    hmm_result_AGC=SearchIO.read(f'{pwd}/server/{pdbfilename[0:-4]}_{model_id}_{chain_id}_AGC.hmmer.txt',format='hmmer3-text')
    hmm_result_CAMK=SearchIO.read(f'{pwd}/server/{pdbfilename[0:-4]}_{model_id}_{chain_id}_CAMK.hmmer.txt',format='hmmer3-text')
    hmm_result_CK1=SearchIO.read(f'{pwd}/server/{pdbfilename[0:-4]}_{model_id}_{chain_id}_CK1.hmmer.txt',format='hmmer3-text')
    hmm_result_CMGC=SearchIO.read(f'{pwd}/server/{pdbfilename[0:-4]}_{model_id}_{chain_id}_CMGC.hmmer.txt',format='hmmer3-text')
    hmm_result_NEK=SearchIO.read(f'{pwd}/server/{pdbfilename[0:-4]}_{model_id}_{chain_id}_NEK.hmmer.txt',format='hmmer3-text')
    hmm_result_RGC=SearchIO.read(f'{pwd}/server/{pdbfilename[0:-4]}_{model_id}_{chain_id}_RGC.hmmer.txt',format='hmmer3-text')
    hmm_result_STE=SearchIO.read(f'{pwd}/server/{pdbfilename[0:-4]}_{model_id}_{chain_id}_STE.hmmer.txt',format='hmmer3-text')
    hmm_result_TKL=SearchIO.read(f'{pwd}/server/{pdbfilename[0:-4]}_{model_id}_{chain_id}_TKL.hmmer.txt',format='hmmer3-text')
    hmm_result_TYR=SearchIO.read(f'{pwd}/server/{pdbfilename[0:-4]}_{model_id}_{chain_id}_TYR.hmmer.txt',format='hmmer3-text')
    hmm_result_HASP=SearchIO.read(f'{pwd}/server/{pdbfilename[0:-4]}_{model_id}_{chain_id}_HASP.hmmer.txt',format='hmmer3-text')
