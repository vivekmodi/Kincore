...
#The script gives weird syntax error when it is run as executable, better run it as python dihedrals.py
...
def compute_dihedrals(pwd,pdbfilename,chain_id,xdfg,dfg_asp,dfg_phe):
